...
//javax
    ...
    ResponseEntity<Resume> uploadImage(@PathVariable Long resumeId, @RequestParam("resumeImage")MultipartFile file) throws IOException{
        Optional<Resume> resume = resumeRepository.findById(resumeId); 
        return resume.isPresent() ? 
                new ResponseEntity<>(resumeService.uploadImage(resume.get(), file), HttpStatus.OK) :
